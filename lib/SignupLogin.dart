            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(83.0, 0.0, 32.0, 32.0),
                    size: Size(199.0, 35.0),
                    pinTop: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(165.0, 0.0, 34.0, 35.0),
                    size: Size(199.0, 35.0),
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    ...
                    child:
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: const AssetImage('assets/linkedin.png'),
                            fit: BoxFit.fill,
                          ),
                        ),
                      ),
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(41.0, 19.0, 67.0, 27.0),
                      size: Size(150.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
