...
import './Interestedtoworklocationaccess.dart';
import 'package:adobe_xd/page_link.dart';
import './Interestedtoworkselectedofflinejob.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Interestedtoworklocationwisejobslist extends StatelessWidget {
  Interestedtoworklocationwisejobslist({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              duration: 0.3,
                              pageBuilder: () =>
                                  Interestedtoworklocationaccess(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
          ...
          Transform.translate(
            offset: Offset(82.0, 80.0),
            child: Text(
              'Nearest available jobs',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 22,
              ...
              child: SingleChildScrollView(
                child: Wrap(
                  ...
                  children: [
                    {
                      'text':
                          'Grocery Shopping (1 km away)\nApprox time : 10 mins ',
                      'text_0':
                          'Gardening (6.5 km away)\nApprox time : 25 mins ',
                    },
                    {
                      'text':
                          'Washing vehicle (7 km away)\nApprox time : 28 mins ',
                      'text_0':
                          'Paying electricity bill (10 km) \nApprox time : 25 mins ',
                    },
                    {
                      'text':
                          'Grocery Shopping (1 km away)\nApprox time : 10 mins ',
                        ...
                        children: <Widget>[
                          SizedBox(
                            ...
                            child: Stack(
                              children: <Widget>[
                                Pinned.fromSize(
                                  bounds: Rect.fromLTWH(0.0, 7.0, 30.0, 30.0),
                                  size: Size(330.0, 56.0),
                                  pinLeft: true,
                                  pinTop: true,
                                  fixedWidth: true,
                                  fixedHeight: true,
                                ...
                                Pinned.fromSize(
                                  bounds: Rect.fromLTWH(46.0, 0.0, 284.0, 56.0),
                                  size: Size(330.0, 56.0),
                                  pinLeft: true,
                                  pinRight: true,
                                  pinTop: true,
                            ...
                            child: PageLink(
                              links: [
                                PageLinkInfo(
                                  ...
                                  duration: 0.3,
                                  pageBuilder: () =>
                                      Interestedtoworkselectedofflinejob(),
                                ),
                              ],
                              child: SizedBox(
                                width: 275.0,
                                ...
                                child: Stack(
                                  children: <Widget>[
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(0.0, 7.0, 30.0, 30.0),
                                      size: Size(275.0, 56.0),
                                      pinLeft: true,
                                      pinTop: true,
                                      fixedWidth: true,
                                      fixedHeight: true,
                                    ...
                                    Pinned.fromSize(
                                      bounds:
                                          Rect.fromLTWH(46.0, 0.0, 229.0, 56.0),
                                      size: Size(275.0, 56.0),
                                      pinRight: true,
                                      pinTop: true,
                                      pinBottom: true,
