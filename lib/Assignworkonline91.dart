...
class Assignworkonline91 extends StatelessWidget {
  Assignworkonline91({
    Key key,
  }) : super(key: key);
  @override
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(30.0, 14.0, 158.0, 33.0),
                      size: Size(217.0, 61.0),
                      pinLeft: true,
                      pinRight: true,
                      fixedHeight: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 44.0, 219.0, 234.0),
                    size: Size(219.0, 278.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 211.0, 26.0),
                    size: Size(219.0, 278.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
