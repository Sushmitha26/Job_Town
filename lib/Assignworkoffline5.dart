...
import './Assignworkoffline2.dart';
import 'package:adobe_xd/page_link.dart';
import './Profile4.dart';
import './Assignworkoffline8.dart';
import './Assignworkoffline6.dart';
import './Assignworkoffline9.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Assignworkoffline5 extends StatelessWidget {
  Assignworkoffline5({
    Key key,
  }) : super(key: key);
  @override
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              ease: Curves.easeOut,
                              duration: 0.3,
                              pageBuilder: () => Assignworkoffline2(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Assignworkoffline8(),
                ),
              ],
              child: SizedBox(
                width: 64.0,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Assignworkoffline6(),
                ),
              ],
              child: Container(
                width: 18.0,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Assignworkoffline9(),
                ),
              ],
              child: Container(
                width: 18.0,
