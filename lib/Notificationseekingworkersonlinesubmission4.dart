...
class Notificationseekingworkersonlinesubmission4 extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(57.0, 17.0, 46.0, 30.0),
                      size: Size(156.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
          ...
          Transform.translate(
            offset: Offset(49.0, 149.0),
            child: Text(
              '@Sowmya has been notified',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 22,
