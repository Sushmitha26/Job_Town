...
import './Notificationseekingjobonline2.dart';
import './Notificationseekingjobonline3.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingjobonline1 extends StatelessWidget {
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjobonline2(),
                ),
              ],
              child: SizedBox(
                width: 181.0,
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 181.0, 64.0),
                      size: Size(181.0, 64.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(58.0, 17.0, 66.0, 30.0),
                      size: Size(181.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjobonline3(),
                ),
              ],
              child: SizedBox(
                width: 181.0,
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(55.0, 17.0, 72.0, 30.0),
                      size: Size(181.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
