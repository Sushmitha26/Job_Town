...
import './Signup22.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Signup21 extends StatelessWidget {
  Signup21({
    Key key,
  }) : super(key: key);
  @override
...
const String _svg_78sqcb =
    '<svg viewBox="76.5 303.5 223.0 59.0" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(76.5, 303.5)" d="M 0 0 L 223 0" fill="none" stroke="#3077d0" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(76.5, 362.5)" d="M 0 0 L 223 0" fill="none" stroke="#090909" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
