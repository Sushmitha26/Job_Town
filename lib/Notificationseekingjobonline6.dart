...
class Notificationseekingjobonline6 extends StatelessWidget {
  Notificationseekingjobonline6({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjobonline7(),
                ),
              ],
              child: SizedBox(
                width: 140.0,
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 140.0, 64.0),
                      size: Size(140.0, 64.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(33.0, 17.0, 78.0, 30.0),
                      size: Size(140.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
