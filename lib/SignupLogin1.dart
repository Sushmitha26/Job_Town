...
class SignupLogin1 extends StatelessWidget {
  SignupLogin1({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 173.0, 64.0),
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(40.0, 19.0, 95.0, 27.0),
                      size: Size(173.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(32.0, 19.0, 110.0, 27.0),
                      size: Size(173.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
