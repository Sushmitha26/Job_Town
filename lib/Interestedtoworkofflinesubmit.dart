...
class Interestedtoworkofflinesubmit extends StatelessWidget {
  Interestedtoworkofflinesubmit({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 102.0, 61.0),
                      size: Size(102.0, 61.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(23.0, 15.0, 49.0, 32.0),
                      size: Size(102.0, 61.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
