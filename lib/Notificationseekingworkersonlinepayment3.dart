...
class Notificationseekingworkersonlinepayment3 extends StatelessWidget {
  Notificationseekingworkersonlinepayment3({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Container(),
          Transform.translate(
            offset: Offset(65.0, 210.0),
            child:
                // Adobe XD layer: 'Google-Pay-Logo-Ico…' (shape)
                PageLink(
              links: [
                PageLinkInfo(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: const AssetImage('assets/Googlepay.png'),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
          ...
          Transform.translate(
            offset: Offset(145.0, 210.0),
            child:
                // Adobe XD layer: 'phone-pe' (shape)
                PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.Fade,
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: const AssetImage('assets/Phonepay.png'),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
          ...
          Transform.translate(
            offset: Offset(206.0, 215.0),
            child:
                // Adobe XD layer: 'Paytm-Logo-With-Whi…' (shape)
                PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.Fade,
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    image: const AssetImage('assets/paytm.png'),
                    fit: BoxFit.fill,
                  ),
                ),
              ),
