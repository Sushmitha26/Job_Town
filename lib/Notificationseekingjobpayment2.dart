...
class Notificationseekingjobpayment2 extends StatelessWidget {
  Notificationseekingjobpayment2({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjobpayment3(),
                ),
              ],
              child: SizedBox(
                width: 152.0,
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 152.0, 64.0),
                      size: Size(152.0, 64.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(39.0, 17.0, 78.0, 30.0),
                      size: Size(152.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
          ...
          Transform.translate(
            offset: Offset(79.0, 149.0),
            child: Text(
              'Job title: Video editor\n\nJob ID: 4561\n\nAmount:              Rs. 1500\n\nApp charges \ndeducted(10%):    Rs. 150\n\nTotal amount:     Rs. 1350',
              style: TextStyle(
