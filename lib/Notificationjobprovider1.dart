...
class Notificationjobprovider1 extends StatelessWidget {
  Notificationjobprovider1({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 249.0, 110.0),
                    size: Size(249.0, 110.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
          ...
          Transform.translate(
            offset: Offset(46.0, 84.0),
            child: Text(
              'Conversation with Ramesh S',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 22,
          ...
          Transform.translate(
            ...
            child: Text(
              'Hi, \nI am interested in the job \nyou have posted for gardening, \nplease can u provide \nfurther details? ',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 15,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 244.0, 138.0),
                    size: Size(244.0, 138.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
          ...
          Transform.translate(
            offset: Offset(134.0, 289.0),
            child: Text(
              'Hi Ramesh,\nThank you for your interest.\nWork will be for 3 days, you can \ncome from tomorrow at \n10:00AM. Contact me for any \nqueries- 9857463210\n',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 15,
                color: const Color(0xff050505),
...
const String _svg_q15nwm =
    '<svg viewBox="28.0 561.0 252.9 48.8" ><path transform="translate(28.0, 561.0)" d="M 7.903717041015625 0 L 245.0152282714844 0 C 249.3803405761719 0 252.9189453125 4.751936435699463 252.9189453125 10.61374759674072 L 252.9189453125 38.20949172973633 C 252.9189453125 44.0713005065918 249.3803405761719 48.82323837280273 245.0152282714844 48.82323837280273 L 7.903717041015625 48.82323837280273 C 3.538614511489868 48.82323837280273 0 44.0713005065918 0 38.20949172973633 L 0 10.61374759674072 C 0 4.751936435699463 3.538614511489868 0 7.903717041015625 0 Z" fill="#f5f5f5" stroke="#707070" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" /></svg>';
