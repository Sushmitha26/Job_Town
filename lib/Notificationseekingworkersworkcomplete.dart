...
class Notificationseekingworkersworkcomplete extends StatelessWidget {
  Notificationseekingworkersworkcomplete({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => NotificationseekingworkersofflineOTP(),
                ),
              ],
              child: SizedBox(
                width: 156.0,
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 156.0, 64.0),
                      size: Size(156.0, 64.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(31.0, 17.0, 94.0, 30.0),
                      size: Size(156.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
          ...
          Transform.translate(
            offset: Offset(57.0, 257.0),
            child: Text(
              '  Click send to proceed by\nsending auto-generated OTP',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 22,
                color: const Color(0xfff7f9fc),
