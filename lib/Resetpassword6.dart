...
class Resetpassword6 extends StatelessWidget {
  Resetpassword6({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                    ...
                    child: PageLink(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(0.5, 0.0, 131.0, 27.0),
                            size: Size(239.0, 32.5),
                            pinLeft: true,
                            pinTop: true,
                            fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 102.5, 239.0, 1.0),
                    size: Size(239.0, 102.5),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.5, 70.0, 167.0, 27.0),
                    size: Size(239.0, 102.5),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(215.0, 74.0, 24.0, 24.0),
                    size: Size(239.0, 102.5),
                    pinRight: true,
                    pinBottom: true,
                    fixedWidth: true,
