...
import './Resetpassword7.dart';
import 'package:adobe_xd/page_link.dart';
import './Login1.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Resetpassword8 extends StatelessWidget {
  Resetpassword8({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 239.0, 98.5),
                    size: Size(239.0, 98.5),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 98.5, 239.0, 1.0),
                          size: Size(239.0, 98.5),
                          pinLeft: true,
                          pinRight: true,
                          pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(215.0, 70.0, 24.0, 24.0),
                    size: Size(239.0, 98.5),
                    pinRight: true,
                    pinBottom: true,
                    fixedWidth: true,
...
const String _svg_zgph6h =
    '<svg viewBox="68.5 275.5 239.0 1.0" ><defs><filter id="shadow"><feDropShadow dx="0" dy="2" stdDeviation="6"/></filter></defs><path transform="translate(68.5, 275.5)" d="M 0 0 L 239 0" fill="none" stroke="#ffffff" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
