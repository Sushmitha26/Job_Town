...
class Notificationseekingjob extends StatelessWidget {
  Notificationseekingjob({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 314.0, 381.0),
                    size: Size(314.0, 381.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(52.0, 177.0, 222.0, 48.0),
                    size: Size(314.0, 381.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(26.0, 185.0, 10.0, 10.0),
                    size: Size(314.0, 381.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(27.0, 65.0, 10.0, 10.0),
                    size: Size(314.0, 381.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(51.0, 235.0, 229.0, 72.0),
                    size: Size(314.0, 381.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                      'There are new jobs available \nthat matches your profile. \nClick to view the top picks!',
                      style: TextStyle(
                        fontFamily: 'Segoe UI',
                        fontSize: 18,
                        color: const Color(0xff000000),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(27.0, 244.0, 10.0, 10.0),
                    size: Size(314.0, 381.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(49.0, 317.0, 158.0, 24.0),
                    size: Size(314.0, 381.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(26.0, 323.0, 10.0, 10.0),
                    size: Size(314.0, 381.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(49.0, 61.0, 235.0, 48.0),
                    size: Size(314.0, 381.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(25.0, 14.0, 24.0, 24.0),
                    size: Size(314.0, 381.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(27.0, 126.0, 10.0, 10.0),
                    size: Size(314.0, 381.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(59.0, 14.0, 54.0, 24.0),
                    size: Size(314.0, 381.0),
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(49.0, 119.0, 240.0, 48.0),
                    size: Size(314.0, 381.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: PageLink(
                      links: [
                        PageLinkInfo(
                          ...
                          ease: Curves.easeOut,
                          duration: 0.3,
                          pageBuilder: () => Notificationseekingjobonline1(),
                        ),
                      ],
                      child: Text(
                        '@John has picked your profile\nfor a job post. Click to view.',
                        style: TextStyle(
                          fontFamily: 'Segoe UI',
                          fontSize: 18,
                          color: const Color(0xff3077d0),
...
const String _svg_1cyls1 =
    '<svg viewBox="3.0 6.0 18.0 12.0" ><path  d="M 3 18 L 21 18 L 21 16 L 3 16 L 3 18 Z M 3 13 L 21 13 L 21 11 L 3 11 L 3 13 Z M 3 6 L 3 8 L 21 8 L 21 6 L 3 6 Z" fill="#000000" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
