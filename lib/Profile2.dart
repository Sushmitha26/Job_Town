      ...
      body: Stack(
        children: <Widget>[
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(30.0, 8.0, 52.0, 27.0),
                      size: Size(112.0, 42.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
          ...
          Transform.translate(
            ...
            child: Text(
              'Successfully completed\ntwo poster designs for\nmarathon and sports events.\n \nDesigned three certificates\nand delivered successfully\n\nDesigned Magazine for\n\'Retailer\'\n',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 20,
                color: const Color(0xff060606),
...
const String _svg_glz8m5 =
    '<svg viewBox="31.0 140.0 314.0 388.0" ><path transform="translate(31.0, 140.0)" d="M 2 0 L 312 0 C 313.1045837402344 0 314 0.8954304456710815 314 2 L 314 386 C 314 387.1045837402344 313.1045837402344 388 312 388 L 2 388 C 0.8954304456710815 388 0 387.1045837402344 0 386 L 0 2 C 0 0.8954304456710815 0.8954304456710815 0 2 0 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
