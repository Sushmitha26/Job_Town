          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(44.5, 185.0, 150.0, 64.0),
                    size: Size(239.0, 249.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 0.0, 150.0, 64.0),
                          size: Size(150.0, 64.0),
                          pinLeft: true,
                          pinRight: true,
                          pinTop: true,
                          pinBottom: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(45.0, 19.0, 55.0, 27.0),
                          size: Size(150.0, 64.0),
                          fixedWidth: true,
                          fixedHeight: true,
                          child: Text(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.5, 0.0, 188.0, 27.0),
                    size: Size(239.0, 249.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.5, 0.0, 94.0, 27.0),
                      size: Size(239.0, 32.5),
                      pinLeft: true,
                      pinTop: true,
                      fixedWidth: true,
...
const String _svg_1m7gcq =
    '<svg viewBox="68.0 319.5 239.0 1.0" ><path transform="translate(68.0, 319.5)" d="M 0 0 L 239 0" fill="none" stroke="#ffffff" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
