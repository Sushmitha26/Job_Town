...
import './Notificationseekingjobpayment1.dart';
import 'package:adobe_xd/page_link.dart';
import './Notificationseekingjobreport1.dart';
import './Homeseeker.dart';
import './Notificationseekingjobrating1.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingjobpayment3 extends StatelessWidget {
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              duration: 0.3,
                              pageBuilder: () =>
                                  Notificationseekingjobpayment1(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjobreport1(),
                ),
              ],
              child: SizedBox(
                width: 218.0,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjobrating1(),
                ),
              ],
              child: SizedBox(
                width: 218.0,
