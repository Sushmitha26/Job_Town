...
class Notificationseekingjobonline21 extends StatelessWidget {
  Notificationseekingjobonline21({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 98.0, 64.0),
                      size: Size(98.0, 64.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(27.0, 17.0, 46.0, 30.0),
                      size: Size(98.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
