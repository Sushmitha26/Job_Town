    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(85.0, 225.0),
            child: Text(
              'Email: rameshs98@gmail.com',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 19,
          ...
          Transform.translate(
            offset: Offset(85.0, 313.0),
            child: Text(
              'Skills: Worked as Gardener\nfor 4 years in Mysore Palace\n\n',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 19,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(51.0, 12.0, 56.0, 27.0),
                    size: Size(157.0, 48.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(22.0, 11.0, 113.0, 27.0),
                    size: Size(157.0, 48.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
