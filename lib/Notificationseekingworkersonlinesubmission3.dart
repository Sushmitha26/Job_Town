...
import './Notificationseekingworkersonlinesubmission31.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingworkersonlinesubmission3 extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(57.0, 17.0, 49.0, 30.0),
                    size: Size(159.0, 64.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
          ...
          Transform.translate(
            offset: Offset(57.0, 89.0),
            child: Text(
              'Suggestions and necessary\n               changes',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 22,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  duration: 0.3,
                  pageBuilder: () =>
                      Notificationseekingworkersonlinesubmission31(),
                ),
              ],
              child: Container(
                width: 210.0,
