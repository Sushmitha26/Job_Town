...
import './NotificationseekingworkersofflineOTP.dart';
import 'package:adobe_xd/page_link.dart';
import './Notificationseekingworkersonlinepayment2.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingworkersonlinepayment1 extends StatelessWidget {
  Notificationseekingworkersonlinepayment1({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              duration: 0.3,
                              pageBuilder: () =>
                                  NotificationseekingworkersofflineOTP(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingworkersonlinepayment2(),
                ),
              ],
              child: SizedBox(
                width: 159.0,
          ...
          Transform.translate(
            offset: Offset(54.0, 119.0),
            child: Text(
              'Type : Google pay/PhonePe',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 22,
