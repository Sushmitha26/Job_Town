...
class Assignworkoffline2 extends StatelessWidget {
  Assignworkoffline2({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 230.0, 63.0),
                      size: Size(230.0, 63.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(52.0, 16.0, 125.0, 32.0),
                      size: Size(230.0, 63.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(23.0, 16.0, 183.0, 32.0),
                      size: Size(230.0, 63.0),
                      pinLeft: true,
                      pinRight: true,
                      fixedHeight: true,
