...
import './Assignworkonline7.dart';
import 'package:adobe_xd/page_link.dart';
import './Assignworkonline10.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Assignworkonline9 extends StatelessWidget {
  Assignworkonline9({
    Key key,
  }) : super(key: key);
  @override
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(13.0, 14.0, 191.0, 33.0),
                      size: Size(217.0, 61.0),
                      pinLeft: true,
                      pinRight: true,
                      fixedHeight: true,
