          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 258.0, 143.0),
                    size: Size(258.0, 143.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(61.0, 61.0, 137.0, 24.0),
                    size: Size(258.0, 143.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Stack(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(65.0, 22.0, 129.0, 32.0),
                    size: Size(258.0, 143.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: PageLink(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(61.0, 92.5, 136.0, 28.0),
                    size: Size(258.0, 143.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Stack(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(67.0, 14.0, 92.0, 33.0),
                      size: Size(217.0, 61.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
