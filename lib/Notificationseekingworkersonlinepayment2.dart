...
import './Notificationseekingworkersonlinepayment3.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingworkersonlinepayment2 extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingworkersonlinepayment3(),
                ),
              ],
              child: SizedBox(
                width: 91.0,
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 91.0, 64.0),
                      size: Size(91.0, 64.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(29.0, 17.0, 33.0, 30.0),
                      size: Size(91.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
          ...
          Transform.translate(
            offset: Offset(70.0, 159.0),
            child: Text(
              'Job title: Poster design\n\nJob ID: 5562\n\nAmount:                   Rs. 1000\n\nApp charges(10%):    Rs. 100\n\nTotal amount:           Rs. 1100    ',
              style: TextStyle(
