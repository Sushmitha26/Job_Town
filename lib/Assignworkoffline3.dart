...
import './Assignworkoffline4.dart';
import './Profile8.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Assignworkoffline3 extends StatelessWidget {
  Assignworkoffline3({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Assignworkoffline4(),
                ),
              ],
              child: SizedBox(
                width: 192.0,
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(52.0, 15.0, 88.0, 32.0),
                      size: Size(192.0, 61.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
