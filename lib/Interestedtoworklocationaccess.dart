...
import './Interestedtoworkmode.dart';
import 'package:adobe_xd/page_link.dart';
import './Interestedtoworklocationwisejobslist.dart';
import './Interestedtoworkallowlocation.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Interestedtoworklocationaccess extends StatelessWidget {
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              ease: Curves.easeOut,
                              duration: 0.3,
                              pageBuilder: () => Interestedtoworkmode(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Interestedtoworklocationwisejobslist(),
                ),
              ],
              child: SizedBox(
                width: 218.0,
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(77.0, 17.0, 54.0, 30.0),
                      size: Size(218.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Interestedtoworkallowlocation(),
                ),
              ],
              child: SizedBox(
                width: 218.0,
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(76.0, 17.0, 50.0, 30.0),
                      size: Size(218.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
