    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(85.0, 276.0),
            child: Text(
              'Mobile no: 9895641236',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 20,
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(39.0, 8.0, 34.0, 27.0),
                      size: Size(112.0, 42.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
