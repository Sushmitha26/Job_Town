    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 314.0, 407.0),
                    size: Size(314.0, 407.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(51.0, 28.0, 183.0, 120.0),
                    size: Size(314.0, 407.0),
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(51.0, 141.0, 158.0, 72.0),
                    size: Size(314.0, 407.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(51.0, 301.0, 240.0, 48.0),
                    size: Size(314.0, 407.0),
                    pinRight: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(26.0, 35.0, 10.0, 10.0),
                    size: Size(314.0, 407.0),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(26.0, 151.0, 10.0, 10.0),
                    size: Size(314.0, 407.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(26.0, 234.0, 10.0, 10.0),
                    size: Size(314.0, 407.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(26.0, 307.0, 10.0, 10.0),
                    size: Size(314.0, 407.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
          ...
          Transform.translate(
            offset: Offset(81.0, 363.0),
            child: Text(
              'Received OTP for payment \nconfirmation',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 18,
                color: const Color(0xff060606),
