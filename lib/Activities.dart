    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(32.0, 8.0, 47.0, 27.0),
                      size: Size(112.0, 42.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(39.0, 12.0, 79.0, 27.0),
                    size: Size(157.0, 48.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
          ...
          Transform.translate(
            offset: Offset(94.0, 189.0),
            child: Text(
              'Applied for the post video \neditor posted by @John yesterday. \n',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 18,
                color: const Color(0xff060606),
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 7.0, 10.0, 10.0),
                    size: Size(176.0, 24.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Container(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(19.0, 0.0, 157.0, 24.0),
                    size: Size(176.0, 24.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
          ...
          Transform.translate(
            offset: Offset(94.0, 378.0),
            child: Text(
              'Profile edited. Added new \naddress',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 18,
                color: const Color(0xff060606),
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 9.0, 10.0, 10.0),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(19.0, 0.0, 108.0, 24.0),
                    size: Size(127.0, 24.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
