...
import './Assignworkonline101.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(85.0, 240.0),
            child: Text(
              'Email: tejasv55@gmail.com',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 19,
          ...
          Transform.translate(
            offset: Offset(85.0, 338.0),
            child: Text(
              'Skills: 5 yrs experience in \ntechnical content writing ',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 19,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Assignworkonline101(),
                ),
              ],
              child: SizedBox(
                width: 112.0,
