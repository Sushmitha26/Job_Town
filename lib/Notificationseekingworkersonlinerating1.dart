...
import './Notificationseekingworkersonlinepaymentsuccess.dart';
import 'package:adobe_xd/page_link.dart';
import './Notificationseekingworkersonlinerating2.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingworkersonlinerating1 extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              duration: 0.3,
                              pageBuilder: () =>
                                  Notificationseekingworkersonlinepaymentsuccess(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingworkersonlinerating2(),
                ),
              ],
              child: SizedBox(
                width: 172.0,
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(52.0, 17.0, 69.0, 30.0),
                      size: Size(172.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(84.0, 0.0, 41.2, 41.2),
                      size: Size(211.2, 41.2),
                      pinTop: true,
                      pinBottom: true,
                      fixedWidth: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(127.0, 0.0, 41.2, 41.2),
                      size: Size(211.2, 41.2),
                      pinTop: true,
                      pinBottom: true,
                      fixedWidth: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(170.0, 0.0, 41.2, 41.2),
                      size: Size(211.2, 41.2),
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
          ...
          Transform.translate(
            offset: Offset(110.0, 301.0),
            child: Text(
              'Any other feedback',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 18,
                color: const Color(0xff84878b),
...
const String _svg_8awmg8 =
    '<svg viewBox="110.5 346.5 155.0 1.0" ><path transform="translate(110.5, 346.5)" d="M 0 0 L 155 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
