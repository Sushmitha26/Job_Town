...
import './Notificationseekingjobpayment2.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingjobpayment1 extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(65.0, 138.0),
            child: Text(
              'Mode of getting paid',
              style: TextStyle(
            ...
            child:
              ...
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjobpayment2(),
                ),
              ],
              child: Container(
                width: 42.0,
