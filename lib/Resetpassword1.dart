            ...
            child: PageLink(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.5, 29.5, 267.0, 1.0),
                      size: Size(267.5, 29.5),
                      pinLeft: true,
                      pinRight: true,
                      pinBottom: true,
                      fixedHeight: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 232.0, 24.0),
                      size: Size(267.5, 29.5),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
...
const String _svg_qgg8y8 =
    '<svg viewBox="54.5 309.5 267.0 1.0" ><path transform="translate(54.5, 309.5)" d="M 0 0 L 267 0" fill="none" stroke="#ffffff" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
