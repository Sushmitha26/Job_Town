...
import './Assignworkoffline5.dart';
import 'package:adobe_xd/page_link.dart';
import './Assignworkoffline12.dart';
import './Assignworkoffline10.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Assignworkoffline9 extends StatelessWidget {
  Assignworkoffline9({
    Key key,
  }) : super(key: key);
  @override
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              ease: Curves.easeOut,
                              duration: 0.3,
                              pageBuilder: () => Assignworkoffline5(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Assignworkoffline12(),
                ),
              ],
              child: SizedBox(
                width: 64.0,
                            ...
                            PageLink(
                              links: [
                                PageLinkInfo(
                                  ...
                                  ease: Curves.easeOut,
                                  duration: 0.3,
                                  pageBuilder: () => Assignworkoffline10(),
                                ),
                              ],
                              child: Container(
                                width: 18.0,
            ...
            child: SizedBox(
              ...
              child: SingleChildScrollView(
                child: Wrap(
                  ...
                  children: [
                    {
                      'text': 'Ramesh S (1 km away)\nApprox time : 10 mins ',
                    },
                    {
                      'text': 'Santosh G (6.5 km away)\nApprox time : 25 mins ',
                    }
                  ].map((map) {
                    final text = map['text'];
                    return SizedBox(
                            ...
                            decoration: BoxDecoration(
                              image: DecorationImage(
                                image: const AssetImage(
                                    'assets/location logo.png'),
                                fit: BoxFit.fill,
                              ),
                            ),
                          ),
                          Transform.translate(
                            offset: Offset(59.0, 0.0),
                            child: Text(
                              text,
                              style: TextStyle(
                                fontFamily: 'Segoe UI',
                ...
                children: <Widget>[
                  Pinned.fromSize(
                    ...
                    child:
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: const AssetImage('assets/location logo.png'),
                          fit: BoxFit.fill,
                        ),
                      ),
                    ),
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(59.0, 0.0, 238.0, 56.0),
                    size: Size(297.0, 56.0),
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(62.0, 0.0, 192.0, 56.0),
                    size: Size(254.0, 56.0),
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
...
const String _svg_es93v5 =
    '<svg viewBox="24.5 598.5 3.0 4.0" ><path transform="translate(24.5, 598.5)" d="M 0 0 L 3 4" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_xyqg34 =
    '<svg viewBox="23.5 219.5 12.0 6.0" ><path transform="translate(23.5, 221.5)" d="M 0 0 L 3 4" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(26.5, 219.5)" d="M 9 0 L 0 6" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
