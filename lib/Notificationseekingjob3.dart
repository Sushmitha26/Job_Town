...
import './Notificationseekingjob2.dart';
import 'package:adobe_xd/page_link.dart';
import './Notificationseekingjob4.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingjob3 extends StatelessWidget {
  Notificationseekingjob3({
    Key key,
  }) : super(key: key);
  @override
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              ease: Curves.easeOut,
                              duration: 0.3,
                              pageBuilder: () => Notificationseekingjob2(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjob4(),
                ),
              ],
              child: SizedBox(
                width: 160.0,
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    ...
                    fixedHeight: true,
                    child: Text(
                      'VX-55555\nYour Job Town verification code is O-7980',
                      style: TextStyle(
                        fontFamily: 'Segoe UI',
                        fontSize: 13,
