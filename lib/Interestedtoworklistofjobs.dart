...
import './Interestedtoworkselectedonlinejob.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Interestedtoworklistofjobs extends StatelessWidget {
  Interestedtoworklistofjobs({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Interestedtoworkselectedonlinejob(),
                ),
              ],
              child: Text.rich(
                TextSpan(
