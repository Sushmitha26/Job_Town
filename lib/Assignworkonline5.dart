...
import './Assignworkonline3.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Assignworkonline5 extends StatelessWidget {
  Assignworkonline5({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'bgimg' (component)
                SizedBox(
              width: 650.0,
              height: 851.0,
              child: bgimg(),
...
const String _svg_a5ih7i =
    '<svg viewBox="78.5 270.5 11.0 7.0" ><path transform="translate(78.5, 273.5)" d="M 0 0 L 3 4" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(81.5, 270.5)" d="M 8 0 L 0 7" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
