...
import './Assignworkoffline31.dart';
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 3401.0, 375.0, 24.0),
                    size: Size(870.0, 4068.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 870.0, 4068.0),
                    size: Size(870.0, 4068.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 4021.0, 375.0, 47.0),
                          size: Size(870.0, 4068.0),
                          pinLeft: true,
                          pinBottom: true,
                          fixedWidth: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(40.0, 4033.0, 21.0, 21.0),
                          size: Size(870.0, 4068.0),
                          pinLeft: true,
                          pinBottom: true,
                          fixedWidth: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(177.0, 4033.0, 21.0, 22.0),
                          size: Size(870.0, 4068.0),
                          pinBottom: true,
                          fixedWidth: true,
                          fixedHeight: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(312.0, 4031.0, 22.0, 26.0),
                          size: Size(870.0, 4068.0),
                          pinBottom: true,
                          fixedWidth: true,
                          fixedHeight: true,
                          child: PageLink(
                            links: [
                              PageLinkInfo(
                                ...
                                ease: Curves.easeOut,
                                duration: 0.3,
                                pageBuilder: () => Assignworkoffline31(),
                              ),
                            ],
                            child: SvgPicture.string(
                              _svg_atkmkr,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(595.0, 0.0, 275.0, 72.0),
                          size: Size(870.0, 4068.0),
                          pinRight: true,
                          pinTop: true,
                          fixedWidth: true,
                          ...
                          child: Stack(
                            children: <Widget>[
                              Pinned.fromSize(
                                bounds: Rect.fromLTWH(21.0, 0.0, 254.0, 72.0),
                                size: Size(275.0, 72.0),
                                pinLeft: true,
                                pinRight: true,
                                pinTop: true,
                                pinBottom: true,
          ...
          Transform.translate(
            ...
            child:
                // Adobe XD layer: 'location2' (shape)
                Container(
              width: 314.0,
              height: 388.0,
              decoration: BoxDecoration(
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 314.0, 48.0),
                    size: Size(314.0, 48.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(119.0, 11.0, 75.0, 27.0),
                    size: Size(314.0, 48.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
