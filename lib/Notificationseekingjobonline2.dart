...
import './Notificationseekingjobonline21.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingjobonline2 extends StatelessWidget {
  Notificationseekingjobonline2({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjobonline21(),
                ),
              ],
              child: SizedBox(
                width: 218.0,
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(27.0, 17.0, 172.0, 30.0),
                      size: Size(218.0, 64.0),
                      pinLeft: true,
                      pinRight: true,
                      fixedHeight: true,
