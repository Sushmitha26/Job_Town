...
import './Notificationseekingworkersonlinesubmission4.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingworkersonlinesubmission31 extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  duration: 0.3,
                  pageBuilder: () =>
                      Notificationseekingworkersonlinesubmission4(),
                ),
              ],
              child: SizedBox(
                width: 159.0,
          ...
          Transform.translate(
            offset: Offset(104.0, 240.0),
            child: Text(
              'Please change the \nbackground colour to \na more pastel palette.',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 17,
...
const String _svg_qp428i =
    '<svg viewBox="111.5 338.5 152.0 1.0" ><path transform="translate(111.5, 338.5)" d="M 0 0 L 152 0" fill="none" stroke="#707070" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
