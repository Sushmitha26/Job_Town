...
import './Interestedtoworklistofjobs.dart';
import 'package:adobe_xd/page_link.dart';
import './Interestedtoworksubmit.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Interestedtoworkselectedonlinejob extends StatelessWidget {
  Interestedtoworkselectedonlinejob({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              ease: Curves.easeOut,
                              duration: 0.3,
                              pageBuilder: () => Interestedtoworklistofjobs(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
          ...
          Transform.translate(
            offset: Offset(47.0, 76.0),
            child: Text(
              'Job title: Poster Designer',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 25,
          ...
          Transform.translate(
            offset: Offset(68.0, 147.0),
            child: Text(
              'Description: design poster\nfor music event\n\nSkills required: Adobe \nPhotoshop\n\nPayment: Rs.500\n\nDeadline:20-04-2021',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 22,
                color: const Color(0xfff5f5f5),
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Interestedtoworksubmit(),
                ),
              ],
              child: SizedBox(
                width: 192.0,
