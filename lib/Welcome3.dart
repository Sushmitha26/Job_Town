    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: PageLink(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border:
                      Border.all(width: 1.0, color: const Color(0xff787878)),
                ),
              ),
            ),
          ),
          Transform.translate(
            offset: Offset(213.0, 577.0),
            child: Container(
              width: 14.0,
              height: 14.0,
              decoration: BoxDecoration(
          ...
          Transform.translate(
            offset: Offset(120.0, 151.0),
            child:
                // Adobe XD layer: 'stress' (shape)
                Container(
              width: 133.0,
              height: 134.0,
              decoration: BoxDecoration(
          ...
          Transform.translate(
            offset: Offset(49.0, 324.0),
            child: Text(
              '   Caught up in a loop of tight \n                schedules?\n   Looking for workers to get \n              your load off?\n\nYou have come to the right place!\n  You can find workers in no time \nand even select according to your \n                    needs',
              style: TextStyle(
                fontFamily: 'Segoe UI Historic',
                fontSize: 19,
                color: const Color(0xff2e76d0),
