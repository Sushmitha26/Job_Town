...
import './Resetpassword6.dart';
import 'package:adobe_xd/page_link.dart';
import './Resetpassword8.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Resetpassword7 extends StatelessWidget {
  Resetpassword7({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 32.5, 239.0, 1.0),
                      size: Size(239.0, 32.5),
                      pinLeft: true,
                      pinRight: true,
                      pinBottom: true,
                      fixedHeight: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.5, 0.0, 167.0, 27.0),
                      size: Size(239.0, 32.5),
                      pinLeft: true,
                      pinTop: true,
                      fixedWidth: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(215.0, 4.0, 24.0, 24.0),
                      size: Size(239.0, 32.5),
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(215.0, 0.0, 24.0, 24.0),
                    size: Size(239.0, 28.5),
                    pinRight: true,
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 28.5, 239.0, 1.0),
                    size: Size(239.0, 28.5),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
...
const String _svg_u2emyo =
    '<svg viewBox="68.5 275.5 239.0 1.0" ><path transform="translate(68.5, 275.5)" d="M 0 0 L 239 0" fill="none" stroke="#ffffff" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
