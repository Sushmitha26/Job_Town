...
class Assignworkonline101 extends StatelessWidget {
  Assignworkonline101({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(15.0, 17.0, 200.0, 30.0),
                      size: Size(231.0, 64.0),
                      pinLeft: true,
                      pinRight: true,
                      fixedHeight: true,
          ...
          Transform.translate(
            offset: Offset(92.0, 134.0),
            child: Text(
              'Notification sent to\nTejas V successfully!\n',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 22,
