              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(36.0, 8.0, 41.0, 27.0),
                      size: Size(112.0, 42.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
...
const String _svg_ogmztp =
    '<svg viewBox="76.5 244.5 223.0 177.0" ><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(76.5, 244.5)" d="M 0 0 L 223 0" fill="none" stroke="#090909" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(76.5, 303.5)" d="M 0 0 L 223 0" fill="none" stroke="#090909" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(76.5, 362.5)" d="M 0 0 L 223 0" fill="none" stroke="#090909" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/><defs><filter id="shadow"><feDropShadow dx="0" dy="3" stdDeviation="6"/></filter></defs><path transform="translate(76.5, 421.5)" d="M 0 0 L 223 0" fill="none" stroke="#090909" stroke-width="2" stroke-miterlimit="4" stroke-linecap="butt" filter="url(#shadow)"/></svg>';
