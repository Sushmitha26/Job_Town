...
import './Homeprovider1.dart';
import 'package:adobe_xd/page_link.dart';
import './Notificationjobprovider1.dart';
import './Profile7.dart';
import './Notificationseekingworkersonlinesubmission1.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationjobprovider extends StatelessWidget {
  Notificationjobprovider({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 75.0, 291.0, 407.0),
                    size: Size(291.0, 482.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(26.0, 0.0, 235.0, 338.0),
                    size: Size(291.0, 482.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(17.0, 98.0, 218.0, 240.0),
                          size: Size(235.0, 338.0),
                          pinLeft: true,
                          pinRight: true,
                          pinBottom: true,
                          fixedHeight: true,
                            ...
                            TextSpan(
                              ...
                              children: [
                                ...
                                TextSpan(
                                  text: '\n@Tejas V ',
                                  style: TextStyle(
                                    color: const Color(0xff3178d0),
                                  ),
                                ),
                                TextSpan(
                                  text:
                                      'is interested in your \ncontent writing job posted \npublicly\n',
                                  style: TextStyle(
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 103.0, 10.0, 10.0),
                          size: Size(235.0, 338.0),
                          pinLeft: true,
                          fixedWidth: true,
                          fixedHeight: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(77.0, 0.0, 0.0, 0.0),
                          size: Size(235.0, 338.0),
                          pinTop: true,
                          fixedWidth: true,
                          fixedHeight: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(45.0, 118.0, 123.0, 20.0),
                          size: Size(235.0, 338.0),
                          fixedWidth: true,
                          fixedHeight: true,
                          child: PageLink(
                            links: [
                              PageLinkInfo(
                                ...
                                ease: Curves.easeOut,
                                duration: 0.3,
                                pageBuilder: () => Notificationjobprovider1(),
                              ),
                            ],
                            child: Text(
                              '(view his message)',
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(73.0, 198.0, 136.0, 20.0),
                          size: Size(235.0, 338.0),
                          pinRight: true,
                          fixedWidth: true,
                          fixedHeight: true,
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(70.0, 278.0, 136.0, 20.0),
                          size: Size(235.0, 338.0),
                          pinRight: true,
                          pinBottom: true,
                          fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(26.0, 304.0, 233.0, 60.0),
                    size: Size(291.0, 482.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
                    child: PageLink(
                      ...
                      child: Stack(
                        children: <Widget>[
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(21.0, 0.0, 212.0, 60.0),
                            size: Size(233.0, 60.0),
                            pinLeft: true,
                            pinRight: true,
                            pinTop: true,
                            pinBottom: true,
                          ...
                          Pinned.fromSize(
                            bounds: Rect.fromLTWH(0.0, 6.0, 10.0, 10.0),
                            size: Size(233.0, 60.0),
                            pinLeft: true,
                            pinTop: true,
                            fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(26.0, 426.0, 205.0, 40.0),
                    size: Size(291.0, 482.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
                    ...
                    child: Stack(
                      children: <Widget>[
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(25.0, 0.0, 180.0, 40.0),
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(0.0, 4.0, 10.0, 10.0),
                          size: Size(205.0, 40.0),
                          pinLeft: true,
                          pinTop: true,
                          fixedWidth: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(20.0, 0.0, 204.0, 60.0),
                    size: Size(224.0, 60.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
