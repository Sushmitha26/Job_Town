...
class Interestedtoworkmode extends StatelessWidget {
  Interestedtoworkmode({
    Key key,
  }) : super(key: key);
  @override
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(77.0, 17.0, 64.0, 30.0),
                      size: Size(218.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Interestedtoworklocationaccess(),
                ),
              ],
              child: SizedBox(
                width: 218.0,
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(76.0, 17.0, 65.0, 30.0),
                      size: Size(218.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
