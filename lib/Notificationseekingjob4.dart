...
import './Notificationseekingjob3.dart';
import 'package:adobe_xd/page_link.dart';
import './Notificationseekingjob5.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingjob4 extends StatelessWidget {
  Notificationseekingjob4({
    Key key,
  }) : super(key: key);
  @override
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              ease: Curves.easeOut,
                              duration: 0.3,
                              pageBuilder: () => Notificationseekingjob3(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjob5(),
                ),
              ],
              child: SizedBox(
                width: 279.0,
