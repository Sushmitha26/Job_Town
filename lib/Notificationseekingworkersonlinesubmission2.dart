...
class Notificationseekingworkersonlinesubmission2 extends StatelessWidget {
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingworkersworkcomplete(),
                ),
              ],
              child: SizedBox(
                width: 183.0,
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 183.0, 64.0),
                      size: Size(183.0, 64.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(20.0, 17.0, 146.0, 30.0),
                      size: Size(183.0, 64.0),
                      pinLeft: true,
                      pinRight: true,
                      fixedHeight: true,
