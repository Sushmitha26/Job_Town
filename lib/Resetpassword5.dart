...
import './Resetpassword4.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Resetpassword5 extends StatelessWidget {
  Resetpassword5({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(76.0, 282.0),
            child: PageLink(
              links: [
                PageLinkInfo(
                  duration: 0.2,
                  pageBuilder: () => Resetpassword4(),
                ),
              ],
              child: SizedBox(
                width: 223.0,
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(44.0, 0.0, 179.0, 27.0),
                      size: Size(223.0, 27.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(76.0, 13.0, 242.0, 34.0),
                    size: Size(354.0, 70.0),
                    pinRight: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                      'VX-55555\nYour Job Town verification code is W-7856',
                      style: TextStyle(
                        fontFamily: 'Segoe UI',
                        fontSize: 13,
