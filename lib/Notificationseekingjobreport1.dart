...
import './Notificationseekingjobreport2.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingjobreport1 extends StatelessWidget {
  Notificationseekingjobreport1({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjobreport2(),
                ),
              ],
              child: SizedBox(
                width: 159.0,
