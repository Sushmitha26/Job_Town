...
import './Notificationjobprovider.dart';
import 'package:adobe_xd/page_link.dart';
import './Notificationseekingworkersonlinesubmission3.dart';
import './Notificationseekingworkersonlinesubmission11.dart';
import './Notificationseekingworkersonlinesubmission2.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingworkersonlinesubmission1 extends StatelessWidget {
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              ease: Curves.easeOut,
                              duration: 0.3,
                              pageBuilder: () => Notificationjobprovider(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                    ...
                    child: PageLink(
                      links: [
                        PageLinkInfo(
                          ...
                          duration: 0.3,
                          pageBuilder: () =>
                              Notificationseekingworkersonlinesubmission3(),
                        ),
                      ],
                      child: Stack(
                        children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(4.0, 0.0, 252.0, 60.0),
                    size: Size(270.0, 437.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    ...
                    child: PageLink(
                      links: [
                        PageLinkInfo(
                          ...
                          duration: 0.3,
                          pageBuilder: () =>
                              Notificationseekingworkersonlinesubmission2(),
                        ),
                      ],
                      child: Stack(
                        children: <Widget>[
