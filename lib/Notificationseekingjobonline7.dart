...
import './Notificationseekingjobonline5.dart';
import 'package:adobe_xd/page_link.dart';
import './Notificationseekingjobonline8.dart';
import './Homeseeker.dart';
import './Notificationseekingjobonline10.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingjobonline7 extends StatelessWidget {
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjobonline8(),
                ),
              ],
              child: SizedBox(
                width: 218.0,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjobonline10(),
                ),
              ],
              child: SizedBox(
                width: 218.0,
