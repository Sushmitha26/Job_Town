...
import './Notificationseekingworkersonlinereport1.dart';
import './Homeprovider.dart';
import './Notificationseekingworkersonlinerating1.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingworkersonlinepaymentsuccess extends StatelessWidget {
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              duration: 0.3,
                              pageBuilder: () =>
                                  Notificationseekingworkersonlinepayment2(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingworkersonlinereport1(),
                ),
              ],
              child: SizedBox(
                width: 218.0,
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 218.0, 64.0),
                      size: Size(218.0, 64.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(49.0, 17.0, 119.0, 30.0),
                      size: Size(218.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(41.0, 17.0, 136.0, 30.0),
                      size: Size(218.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingworkersonlinerating1(),
                ),
              ],
              child: SizedBox(
                width: 218.0,
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(7.0, 17.0, 204.0, 30.0),
                      size: Size(218.0, 64.0),
                      pinLeft: true,
                      pinRight: true,
                      fixedHeight: true,
