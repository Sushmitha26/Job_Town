...
import './Notificationseekingworkersworkcomplete.dart';
import 'package:adobe_xd/page_link.dart';
import './Notificationseekingworkersonlinepayment1.dart';
import 'package:flutter_svg/flutter_svg.dart';

class NotificationseekingworkersofflineOTP extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingworkersonlinepayment1(),
                ),
              ],
              child: SizedBox(
                width: 156.0,
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(20.0, 17.0, 116.0, 30.0),
                      size: Size(156.0, 64.0),
                      pinLeft: true,
                      pinRight: true,
                      fixedHeight: true,
          ...
          Transform.translate(
            offset: Offset(77.0, 119.0),
            child: Text(
              'OTP has been sent and\n  verified successfully',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 22,
