...
import './Assignworkoffline1.dart';
import 'package:adobe_xd/page_link.dart';
import './Assignworkoffline2.dart';
import './Profile6.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Assignworkoffline31 extends StatelessWidget {
  Assignworkoffline31({
    Key key,
  }) : super(key: key);
  @override
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              ease: Curves.easeOut,
                              duration: 0.3,
                              pageBuilder: () => Assignworkoffline1(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(13.0, 14.0, 158.0, 33.0),
                      size: Size(217.0, 61.0),
                      pinLeft: true,
                      fixedWidth: true,
                      fixedHeight: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(177.5, 33.5, 27.0, 1.0),
                      size: Size(217.0, 61.0),
                      pinRight: true,
                      fixedWidth: true,
                      fixedHeight: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(192.5, 26.5, 11.0, 7.0),
                      size: Size(217.0, 61.0),
                      pinRight: true,
                      fixedWidth: true,
                      fixedHeight: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(192.5, 33.5, 11.0, 7.0),
                      size: Size(217.0, 61.0),
                      pinRight: true,
                      fixedWidth: true,
                      fixedHeight: true,
...
const String _svg_11bghl =
    '<svg viewBox="244.3 458.5 27.0 1.0" ><path transform="translate(244.28, 458.5)" d="M 0 0 L 27 0" fill="none" stroke="#707070" stroke-width="3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_yn2nwi =
    '<svg viewBox="259.3 451.5 11.0 7.0" ><path transform="translate(259.28, 451.5)" d="M 0 0 L 11 7" fill="none" stroke="#707070" stroke-width="3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_v2km5k =
    '<svg viewBox="259.3 458.5 11.0 7.0" ><path transform="translate(259.28, 458.5)" d="M 11 0 L 0 7" fill="none" stroke="#707070" stroke-width="3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
