...
import './Interestedtoworklocationwisejobslist.dart';
import 'package:adobe_xd/page_link.dart';
import './Interestedtoworkofflinesubmit.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Interestedtoworkselectedofflinejob extends StatelessWidget {
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Interestedtoworkofflinesubmit(),
                ),
              ],
              child: SizedBox(
                width: 192.0,
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(0.0, 0.0, 192.0, 61.0),
                      size: Size(192.0, 61.0),
                      pinLeft: true,
                      pinRight: true,
                      pinTop: true,
                      pinBottom: true,
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(42.0, 15.0, 107.0, 32.0),
                      size: Size(192.0, 61.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
