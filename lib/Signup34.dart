...
import './Signup36.dart';
import 'package:adobe_xd/page_link.dart';
import './Signup14.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Signup34 extends StatelessWidget {
  Signup34({
    Key key,
  }) : super(key: key);
  @override
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(45.0, 19.0, 52.0, 27.0),
                      size: Size(150.0, 64.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(5.0, 4.0, 8.0, 9.0),
                    size: Size(18.0, 18.0),
                    pinTop: true,
                    pinBottom: true,
                    fixedWidth: true,
