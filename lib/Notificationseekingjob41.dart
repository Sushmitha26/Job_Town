...
import './Notificationseekingjob32.dart';
import 'package:adobe_xd/page_link.dart';
import './Notificationseekingjob51.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingjob41 extends StatelessWidget {
  Notificationseekingjob41({
    Key key,
  }) : super(key: key);
  @override
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              ease: Curves.easeOut,
                              duration: 0.3,
                              pageBuilder: () => Notificationseekingjob32(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
