...
import './Notificationseekingjobpayment3.dart';
import 'package:adobe_xd/page_link.dart';
import './Notificationseekingjobrating2.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingjobrating1 extends StatelessWidget {
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              duration: 0.3,
                              pageBuilder: () =>
                                  Notificationseekingjobpayment3(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjobrating2(),
                ),
              ],
              child: SizedBox(
                width: 172.0,
