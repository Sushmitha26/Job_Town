...
class Notificationseekingjob51 extends StatelessWidget {
  Notificationseekingjob51({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 28.0, 27.0),
                    size: Size(221.0, 27.0),
                    pinLeft: true,
                    pinTop: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(42.0, 0.0, 179.0, 27.0),
                    size: Size(221.0, 27.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(47.0, 0.0, 12.0, 12.0),
                    size: Size(153.0, 12.0),
                    pinTop: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(94.0, 0.0, 12.0, 12.0),
                    size: Size(153.0, 12.0),
                    pinTop: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(141.0, 0.0, 12.0, 12.0),
                    size: Size(153.0, 12.0),
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
