...
import './Assignworkonline10.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Assignworkoffline12 extends StatelessWidget {
  Assignworkoffline12({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(67.0, 111.0),
            child: Text(
              '2 users are selected',
              style: TextStyle(
                fontFamily: 'Segoe UI',
                fontSize: 28,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 229.0, 61.0),
                    size: Size(229.0, 61.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(19.0, 14.0, 202.0, 33.0),
                    size: Size(229.0, 61.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
                    child: PageLink(
                      links: [
                        PageLinkInfo(
                          ...
                          ease: Curves.easeOut,
                          duration: 0.3,
                          pageBuilder: () => Assignworkonline10(),
                        ),
                      ],
                      child: Text(
                        'Send Notifications',
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 266.0, 56.0),
                    size: Size(283.0, 146.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    fixedHeight: true,
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(57.0, 0.0, 209.0, 56.0),
                          size: Size(266.0, 56.0),
                          pinRight: true,
                          pinTop: true,
                          pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 90.0, 283.0, 56.0),
                    size: Size(283.0, 146.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                          bounds: Rect.fromLTWH(57.0, 0.0, 226.0, 56.0),
                          size: Size(283.0, 56.0),
                          pinRight: true,
                          pinTop: true,
                          pinBottom: true,
