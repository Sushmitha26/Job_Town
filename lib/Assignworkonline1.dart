...
import './Assignworkonline91.dart';
import 'package:adobe_xd/page_link.dart';
import './Assignworkonline92.dart';
import './Assignworkonline3.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Assignworkonline1 extends StatelessWidget {
  Assignworkonline1({
    Key key,
  }) : super(key: key);
  @override
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              ease: Curves.easeOut,
                              duration: 0.3,
                              pageBuilder: () => Assignworkonline91(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Assignworkonline92(),
                ),
              ],
              child: SizedBox(
                width: 230.0,
