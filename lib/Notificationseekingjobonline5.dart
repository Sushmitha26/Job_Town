...
import './Notificationseekingjob51.dart';
import 'package:adobe_xd/page_link.dart';
import './Notificationseekingjobonline6.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingjobonline5 extends StatelessWidget {
                        ...
                        child: PageLink(
                          links: [
                            PageLinkInfo(
                              ...
                              ease: Curves.easeOut,
                              duration: 0.3,
                              pageBuilder: () => Notificationseekingjob51(),
                            ),
                          ],
                          child: SvgPicture.string(
                            _svg_atkmkr,
            ...
            child:
              ...
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjobonline6(),
                ),
              ],
              child: Container(
                width: 42.0,
