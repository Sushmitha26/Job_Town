...
import './Notificationseekingjob31.dart';
import 'package:flutter_svg/flutter_svg.dart';

class Notificationseekingjob2 extends StatelessWidget {
  Notificationseekingjob2({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => Notificationseekingjob31(),
                ),
              ],
              child: SizedBox(
                width: 218.0,
